...
ALTER PROCEDURE FTC_Relat_Avaliacao_Institucional
...
where NOME = 'FTC_Relat_Avaliacao_Institucional'
...
SELECT
  'FTC_Relat_Avaliacao_Institucional' NOME
, '0001' IDENTIFICAO_CODIGO
, 'Miguel' AUTOR
, '2018-01-18' DATA_CRIACAO
, 'Relatório de Avaliação Institucional (Resultado)' OBJETIVO
, 'Liane Soares, Dayse Ackerman' SOLICITADO_POR
, 'S' ATIVO
