-- EP PROGRAMADO  
CREATE FUNCTION dbo.fnGetDtContabil  
(  
...
BEGIN    
 ...
 DECLARE @P_ENTIDADE VARCHAR(20)   
 DECLARE @P_ID1 VARCHAR(20) 
 DECLARE @P_ID2 VARCHAR(20) 

 SET @P_ENTIDADE = 'Ly_Item_Lanc'
 -- ----------------------------------------------------------------------    
