...
--JOIN TEMP T ON T.ALUNO = R.ALUNO
WHERE R.ANO = @p_ano
...
AND R.STATUS_FTC IN ('MATRICULADO PAGO','PRE-MATRICULADO PAGO','CONCLUIDO','INCONCLUIDO')
AND R.TIPO_FINAN IN ('FIES','PAGANTES','BOLSISTA')
AND R.PAGO = 1
...
AND NOT EXISTS (SELECT TOP 1 1 FROM TEMP_BOLSA B1 WHERE B1.ALUNO = B.ALUNO AND B1.ANO = @p_ano 
		...
		WHERE EXISTS (	SELECT TOP 1 1 
						...
						AND T2.ANOFIM = T1.ANOFIM
						AND T2.MESFIM = T1.MESFIM
		...
		ORDER BY ALUNO,NUM_BOLSA,ANOINI,MESINI
		...
		WHILE @@FETCH_STATUS = 0
		BEGIN
			IF @p_perc_valor3 = 'Percentual' and @p_valor3 = 1.00
			BEGIN
			UPDATE B SET B.VALOR_PARCELA_SEM_ISENCAO = 0
			FROM BI_DMP2 B
			WHERE B.ANO = @p_ano AND B.SEMESTRE = @p_semestre AND B.ALUNO = @p_aluno3
			END
...
FROM BI_DMP2 B
WHERE QTD_PARCELAS_SEM_ISENCAO = 0 AND QTD_PARCELAS_ISENCAO <> 0
AND B.ANO = @p_ano
AND B.SEMESTRE = @p_semestre

		
UPDATE B SET B.QTD_PARCELAS_SEM_ISENCAO = 6-QTD_PARCELAS_ISENCAO
FROM BI_DMP2 B
WHERE QTD_PARCELAS_SEM_ISENCAO = 0 AND QTD_PARCELAS_ISENCAO <> 0
AND B.ANO = @p_ano
AND B.SEMESTRE = @p_semestre
...
UPDATE B SET B.VALOR_PARCELA_ISENCAO = B.VALOR_PARCELA_ISENCAO/B.QTD_PARCELAS_ISENCAO
FROM BI_DMP2 B
WHERE B.ANO = @p_ano AND B.SEMESTRE = @p_semestre
...
UPDATE B SET DMP = 1 - ((VALOR_PARCELA_ISENCAO*QTD_PARCELAS_ISENCAO)+(VALOR_PARCELA_SEM_ISENCAO*(6-QTD_PARCELAS_ISENCAO)))/VALOR_DIVIDA
FROM BI_DMP2 B
WHERE B.VALOR_DIVIDA > 0.00
AND B.QTD_PARCELAS_ISENCAO > 0
AND B.ANO = @p_ano AND B.SEMESTRE = @p_semestre
...
--UPDATE D SET D.DMP = D.DMP/6 
--FROM BI_DMP2 D
--WHERE NOT EXISTS (SELECT TOP 1 1 
--					FROM TEMP_BOLSA 
--					WHERE ALUNO = D.ALUNO 
--					AND ISENCAO = 'N')
--AND D.ANO = @p_ano AND D.SEMESTRE = @p_semestre
...
UPDATE BI_DMP2 SET DMP = 1.00, DMP_SEM_ISENCAO = 1.00 WHERE VALOR_DIVIDA = 0.00 AND ANO = @p_ano AND SEMESTRE = @p_semestre
...
UPDATE BI_DMP2 SET NOME_CURSO = 'Engenharia Elétrica - Automação' WHERE NOME_CURSO = 'Engenharia Elétrica Automação' AND ANO = @p_ano AND SEMESTRE = @p_semestre
UPDATE BI_DMP2 SET NOME_CURSO = 'Administração FGV' WHERE NOME_CURSO = 'Administração - FGV' AND ANO = @p_ano AND SEMESTRE = @p_semestre
UPDATE BI_DMP2 SET NOME_CURSO = 'Direito' WHERE NOME_CURSO = 'Bacharel em Direito' AND ANO = @p_ano AND SEMESTRE = @p_semestre
UPDATE BI_DMP2 SET NOME_CURSO = 'Ciências Aeronáuticas' WHERE NOME_CURSO = 'Ciências Aeronáuticas - Piloto Comercial' AND ANO = @p_ano AND SEMESTRE = @p_semestre
UPDATE BI_DMP2 SET NOME_CURSO = 'Ciências Contábeis' WHERE NOME_CURSO = 'Ciências Contábeis (Noturno) CESUFS' AND ANO = @p_ano AND SEMESTRE = @p_semestre
UPDATE BI_DMP2 SET NOME_CURSO = 'Cinema e Vídeo' WHERE NOME_CURSO = 'Comunicação Social - Cinema e Vídeo' AND ANO = @p_ano AND SEMESTRE = @p_semestre
UPDATE BI_DMP2 SET NOME_CURSO = 'Jornalismo' WHERE NOME_CURSO = 'Comunicação Social - Jornalismo' OR NOME_CURSO = 'Comunicação Social com Habilitação em Jornalismo' AND ANO = @p_ano AND SEMESTRE = @p_semestre
UPDATE BI_DMP2 SET NOME_CURSO = 'Design de Interiores' WHERE NOME_CURSO = 'Curso Superior de Tecnologia em DESIGN DE INTERIORES' AND ANO = @p_ano AND SEMESTRE = @p_semestre
UPDATE BI_DMP2 SET NOME_CURSO = 'Psicologia' WHERE NOME_CURSO = 'Psicologia - Formação de Psicólogo' AND ANO = @p_ano AND SEMESTRE = @p_semestre
UPDATE BI_DMP2 SET NOME_CURSO = 'Publicidade e Propaganda' WHERE NOME_CURSO = 'Comunicação Social - Publicidade e Propaganda' OR NOME_CURSO = 'Comunicação Social com Habilitação em Publicidade e Propaganda' AND ANO = @p_ano AND SEMESTRE = @p_semestre
UPDATE BI_DMP2 SET NOME_CURSO = 'Gestão de Recursos Humanos' WHERE NOME_CURSO = 'Tecnológico em Gestão de Recursos Humanos' AND ANO = @p_ano AND SEMESTRE = @p_semestre
UPDATE BI_DMP2 SET NOME_CURSO = 'Gestão Financeira' WHERE NOME_CURSO = 'Tecnológico em Gestão Financeira' AND ANO = @p_ano AND SEMESTRE = @p_semestre
UPDATE BI_DMP2 SET NOME_CURSO = 'Logística' WHERE NOME_CURSO = 'Tecnológico em Logística' AND ANO = @p_ano AND SEMESTRE = @p_semestre
UPDATE BI_DMP2 SET NOME_CURSO = 'Radiologia' WHERE NOME_CURSO = 'Tecnológico em Radiologia' OR NOME_CURSO = 'Tecnólogo em Radiologia' AND ANO = @p_ano AND SEMESTRE = @p_semestre
UPDATE BI_DMP2 SET NOME_CURSO = 'Estética e Cosmética' WHERE NOME_CURSO = 'Tecnólogo em Estética e Cosmética' AND ANO = @p_ano AND SEMESTRE = @p_semestre
