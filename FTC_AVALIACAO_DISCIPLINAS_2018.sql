...
*/  
-- Teste:  
--EXEC FTC_Relat_Avaliacao_Docente_2018 'Avaliação Docente II', 'AVALDOCENTE2_20181', '03', NULL, NULL, NULL,NULL,'1'
...
DECLARE  
  ...
  */
  ...
  IF @p_avaliacaoq IN ('Avaliação DocenteIV','Avaliação DocenteII')
	...
	BEGIN
		EXEC FTC_Relat_Avaliacao_Coordenador_2018 @p_avaliacaoq, @p_aplicacao, @p_unidade, @p_curso, @p_docente, @p_turma, @p_disciplina
		RETURN
	END
