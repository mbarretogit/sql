	...
	Begin
			...
			if exists ( 
						...
						JOIN LY_CONJ_ALUNO CA
						    ON A.ALUNO  = CA.ALUNO
						where 1 = 1 
						and isnull(c.TIPO,'')   in ('GRADUACAO')
			...
			if exists ( 
				...
				Begin
					--## Seta padrão de acesso
					SET @p_PadAcessoAlterado = 'DOM_AONLINE'
				END
...
, 'Raul' AUTOR
, '2015-12-11' DATA_CRIACAO
, 'EP para definir o padrão de acesso do aluno quando acessa o portal.' OBJETIVO
, '' SOLICITADO_POR
, 'S' ATIVO
