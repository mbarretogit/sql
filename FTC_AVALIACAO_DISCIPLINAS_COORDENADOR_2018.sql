...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.FTC_Relat_Avaliacao_Coordenador_2018'))
   exec('CREATE PROCEDURE [dbo].[FTC_Relat_Avaliacao_Coordenador_2018] AS BEGIN SET NOCOUNT OFF; END')
GO 

ALTER PROCEDURE FTC_Relat_Avaliacao_Coordenador_2018
...
*/
-- Teste:
--EXEC FTC_Relat_Avaliacao_Coordenador_2018 'Avaliação Docente II', 'AVALDOCENTE2_20181', '03', NULL, NULL,NULL,NULL
...
IF @p_avaliacaoq = 'Avaliação DocenteIII'
	...
	(
		...
		MTO_SATISF NUMERIC(10,2),
		SATISF NUMERIC(10,2),
		PARC_SATISF NUMERIC(10,2),
		INSATISF NUMERIC(10,2),
		NAOSEI NUMERIC(10,2),
		NUMERO INT,
	)
