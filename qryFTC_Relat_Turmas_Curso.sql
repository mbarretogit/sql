...
VALUES('Lyceum','AcademicoNG','FTC_Relat_Turmas_Curso','Relatório de Turmas por Unidade e Curso','/Lyceum/Academico/FTC_Relat_Turmas_Curso','N',NULL,'sqlserver')
GO
...
,('Lyceum','AcademicoNG','FTC_Relat_Turmas_Curso','p_tipo','4','5','Tipo de Curso:','N',NULL,'SP: Relat_P_TipoCurso()','CODIGO','DESCR','Tipo de Curso, Descrição','N')
,('Lyceum','AcademicoNG','FTC_Relat_Turmas_Curso','p_curso','5','5','Curso:','N',NULL,'SP: Relat_P_Curso()','CODIGO','DESCR','Curso, Descrição','N')
GO
