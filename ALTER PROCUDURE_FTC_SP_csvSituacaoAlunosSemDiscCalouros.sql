...
CREATE PROCEDURE dbo.FTC_SP_csvSituacaoAlunosSimplificadaCalouros       
(        
  @P_ANO VARCHAR(4)  
...
FROM LY_ALUNO A         
JOIN (SELECT ANO, SEMESTRE, DISCIPLINA, TURMA, ALUNO, SIT_MATRICULA, LANC_DEB, DT_ULTALT , SERIE_CALCULO, COBRANCA_SEP, SIT_DETALHE, GRUPO_ELETIVA , DT_INSERCAO, 'S' AS CONFIRMADA  
...
WHERE 1=1 AND PM.ANO = '2017' AND PM.SEMESTRE = '2' AND C.TIPO IN ('GRADUACAO','TECNOLOGO')
